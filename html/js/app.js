    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>出生年月日: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>性別: </strong><span>" +
                gender +
                "</span></p><p><strong>國籍: </strong><span>" +
                itemData.info.nationality +
                "</span></p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>"
            );
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>出生年月日: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>許可類型: </strong><span>" +
                itemData.info.type +
                "</span></p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>"
            );
            ...
            $(".item-info-description").html( // might need to come back
                "<p>" + itemData.info.uses + " uses left.</p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            if (itemData.info.serie != null) {
                $(".item-info-description").html(
                    "<p><strong>序號: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>"
                );
            } else {
                $(".item-info-description").html(
                    ...
                    "</p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>"
                );
            }
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.costs + "</p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "stickynote") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.label + "</p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "moneybag") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>金額: </strong><span>$" +
                itemData.info.cash +
                "</span></p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>"
            );
            ...
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>Card Holder: </strong><span>' + itemData.info.name + '</span></p><p><strong>Citizen ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Card Number: </strong><span>' + cardNumber + '</span></p><p style=\"font-size:1.4vh\"><b>重量: </b>' + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "labkey") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Lab: " + itemData.info.lab + "</p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "lowervaultcodes") {
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>' + itemData.description + '</p><p>通關密碼: ' + itemData.info.codes + '</p>' + "</p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>");
        } else {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>");
        }
    } else {
        $(".item-info-title").html("<p>" + itemData.label + "</p>");
        $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:1.4vh\"><b>重量: </b>" + (itemData.weight * itemData.amount / 1000).toFixed(1) + " | <b>數量: </b> " + itemData.amount + " | <b>品質: </b> " + "<a style=\"font-size:1.4vh\">" + Math.floor(itemData.info.quality) + "</a>");
...
function updateweights($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (
        ...
        ($fromInv.attr("data-inventory").split("-")[0] == "mechanicshop" &&
            $toInv.attr("data-inventory").split("-")[0] == "mechanicshop") ||
        ($fromInv.attr("data-inventory").split("-")[0] == "catcafeshop" &&
            $toInv.attr("data-inventory").split("-")[0] == "catcafeshop") ||
        ($fromInv.attr("data-inventory").split("-")[0] == "burgershotshop" &&
            $toInv.attr("data-inventory").split("-")[0] == "burgershotshop") ||
        ($fromInv.attr("data-inventory") == "crafting" &&
            $toInv.attr("data-inventory") == "crafting")
    ) {
        itemData = $fromInv.find("[data-slot=" + $fromSlot + "]").data("item");
        if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop" || $fromInv.attr("data-inventory").split("-")[0] == "mechanicshop" || $fromInv.attr("data-inventory").split("-")[0] == "catcafeshop" || $fromInv.attr("data-inventory").split("-")[0] == "burgershotshop") {
            $fromInv
    ...
    if (
        ...
        if ($toInv.attr("data-inventory").split("-")[0] == "itemshop" || $toInv.attr("data-inventory").split("-")[0] == "mechanicshop" || $toInv.attr("data-inventory").split("-")[0] == "catcafeshop" || $toInv.attr("data-inventory").split("-")[0] == "burgershotshop") {
            $toInv
...
(() => {
    ...
    Inventory.Open = function (data) {
        ...
        if (data.other != null) {
            ...
            if (
                name != null &&
                (name.split("-")[0] == "itemshop" || name.split("-")[0] == "mechanicshop" || name.split("-")[0] == "catcafeshop" || name.split("-")[0] == "burgershotshop" || name == "crafting")
            ) {
